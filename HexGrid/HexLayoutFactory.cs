namespace Barbar.HexGrid
{
    public static class HexLayoutFactory
    {
        ...
        public static HexLayout CreatePointyHexLayout(Point size, Point origin, Offset offset)
        {
            return new HexLayout(Orientation.PointyHexagons, size, origin, offset);
        }

        public static HexLayout CreateFlatHexLayout(Point size, Point origin, Offset offset)
        {
            return new HexLayout(Orientation.FlatHexagons, size, origin, offset);
        }
